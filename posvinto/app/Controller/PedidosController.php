            ...
            if ($anadido == 1)
            {
               $anadidos = $this->Item->find('all', array('conditions'=>array('Item.pedido_id'=>$pedido, 'Item.estado'=>1)));
                ...
                foreach ($anadidos as $a)
                {
                    ...
                    'conditions' => array('Item.pedido_id' =>$pedido, 'Item.producto_id' => $a['Item']['producto_id'], 'Item.estado' => 0)
                    ));
