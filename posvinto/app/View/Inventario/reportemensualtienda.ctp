...
<?php $depo = 0; ?>
<tr>
	<td class="totald">Total ventas</td>
    <?php $depo = $total1 + $total2 + $total3 + $totchip + $totac + $totcab; ?>
...
<tr>
   <td>Total ganancia mensual</td>
   <?php $totg = $depo - $totinv;?>
   <td><?php echo $totg;?></td>
</tr>
</table>
