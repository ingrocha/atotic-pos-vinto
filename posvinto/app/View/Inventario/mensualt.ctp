<script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                jQuery('#UsuarioInformeclientestForm').validationEngine();
                jQuery('#UsuarioReportemensualtiendaForm').validationEngine();
...
<div class="centered">
   <div class="grid-2">
      ...
      <?php echo $this->Form->create(null, array('action'=>'informeclientest'));?>
         <div class="elem">
   ...
   <div class="grid-2">
       ...
       <div class="content-gird">
       <?php echo $this->Form->create(null, array('action'=>'reportemensualtienda'))?>
         <div class="elem">
                  <label>Seleccione usuario:</label>
                  <div class="right">
