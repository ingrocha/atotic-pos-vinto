        ...
        <section>            
            <div class="row-fluid">                
                ...
                <div class="page-header">
                    <h3><i class="fontello-icon-article-alt opaci35"></i> Nueva <small>Categoria de almacen</small></h3>
                </div>
                <div class="span10 well well-nice">
                    <fieldset>
                        <legend>Formulario <small>CATEGOR&Iacute;A</small></legend>
                        ...
                        <!-- // form item -->
                        <button class="btn btn-green" type="submit">Guardar Categor&iacute;a</button>
                        </form>
                    </fieldset>
