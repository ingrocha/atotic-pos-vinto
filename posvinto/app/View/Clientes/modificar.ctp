		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Modificar Cliente</h2>
...
<div style="clear: both;"></div>
			...
			<div id="sidebar">
				...
				<div class="box">
                    ...
                    <?php //echo $this->Html->link(<span>'Nuevo Usuario'</span>, 'nuevo'); ?> 
							<a href="http://localhost/postvinto/posvinto/clientes/nuevo" class="add-button"><span>Nuevo Cliente</span></a>
						<div class="cl">&nbsp;</div>
