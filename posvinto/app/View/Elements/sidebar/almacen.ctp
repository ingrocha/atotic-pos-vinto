<div id="main-sidebar" class="sidebar">
    ...
    <ul id="mainSideMenu" class="nav nav-list nav-side">
        <li class="accordion-group active">
            ...
            <ul class="accordion-content nav nav-list collapse in" id="accDash">
                <li> <a href="<?php echo $this->Html->url(array('controller'=>'Insumos', 'action'=>'index')); ?>"> <i class="fontello-icon-right-dir"></i> <span class="hidden-tablet">Bodega</span> </a> </li>
            </ul>
        </li>
       ...
       <li class="accordion-group active">
            ...
            <ul class="accordion-content nav nav-list collapse in" id="accDash">
            <li> <a href="<?php echo $this->Html->url(array('controller'=>'Insumos', 'action'=>'bodega')); ?>"> <i class="fontello-icon-right-dir"></i> <span class="hidden-tablet">Listado de Bodegas</span></a> </li>
            </ul>
        </li>
        <li class="accordion-group active">
    ...
    <ul id="mainSideMenu" class="nav nav-list nav-side">
        <li class="accordion-group active">
            ...
            <li><?php echo $this->Html->image('iconos/edit.png')?>&nbsp;&nbsp;&nbsp;Edita el Almacen</li>
            <li><?php echo $this->Html->image('iconos/elim.png')?>&nbsp;&nbsp;&nbsp;Elimina el Almacen</li>
            </ul>
        </li>
        <!-- // item accordionMenu Dashboard -->
