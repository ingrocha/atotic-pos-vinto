<script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                jQuery("#UsuarioInventariodistribuidorForm").validationEngine();
                jQuery('#UsuarioImensualdForm').validationEngine();
            });
        </script>
<div class="centered">
<div  class="grid-1">
   <div class="title-grid">
       <span>Reportes Inventarios distribuidores</span>
   </div>
</div>
   ...
   <div class="grid-2">
      ...
      <?php echo $this->Form->create(null, array('action'=>'inventariodistribuidor'));?>
         <div class="elem">
   ...
   <div class="grid-2">
       ...
       <div class="content-gird">
       <?php echo $this->Form->create(null, array('action'=>'imensuald'))?>
         <div class="elem">
                  <label>Seleccione usuario:</label>
                  <div class="right">
