        ...
        <section>            
            <div class="row-fluid">                
                ...
                <div class="page-header">
                    <h3><i class="fontello-icon-article-alt opaci35"></i> Editar <small>Cliente</small></h3>
                </div>
                <div class="span10 well well-nice">
                    <fieldset>
                        <legend>Formulario <small>EDITAR CLIENTE</small></legend>
                        ...
                        <button class="btn btn-green" type="submit">Editar Usuario</button>
                        </form>
                    </fieldset>
