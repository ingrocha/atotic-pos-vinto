<div id="main-sidebar" class="sidebar">
    ...
    <ul id="mainSideMenu" class="nav nav-list nav-side">
        <li class="accordion-group active">
            ...
            <li><?php echo $this->Html->image('iconos/edit.png')?>&nbsp;&nbsp;&nbsp;Edita el Plato</li>
            <li><?php echo $this->Html->image('iconos/receta.png')?>&nbsp;&nbsp;&nbsp;Receta del Plato</li>
            <li><?php echo $this->Html->image('iconos/elim.png')?>&nbsp;&nbsp;&nbsp;Elimina el Plato</li>
            </ul>
        </li>
        <!-- // item accordionMenu Dashboard -->
