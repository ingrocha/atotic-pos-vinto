    ...
    <ul id="mainSideMenu" class="nav nav-list nav-side">
        ...
        <li class="accordion-group active">
            ...
            <ul class="accordion-content nav nav-list collapse in" id="accDash">
                ...
                <li> <a href="<?php echo $this->Html->url(array('controller'=>'parametrosfacturas', 'action'=>'insertar')); ?>"> <i class="fontello-icon-right-dir"></i> <span class="hidden-tablet">Nueva configuraci&oacute;n</span> </a> </li>
            </ul>
        </li>
